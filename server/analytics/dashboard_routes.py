...
async def add_widget_to_dashboard(dashboard_id: str, request: CreateWidgetRequest):
...
async def get_current_tracking_metrics():
...
async def websocket_real_time_updates(websocket: WebSocket, user_id: Optional[str] = None):

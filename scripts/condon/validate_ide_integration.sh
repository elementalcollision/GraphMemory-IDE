...
if [ -f ".cursor/rules/condon-development.mdc" ]; then
    echo "✓ Condon development rules found"
else
    echo "✗ Condon development rules not found"
fi
...
echo "6. Testing Condon CLI integration..."
...
if [ -f ".cursor/rules/condon-development.mdc" ]; then
    echo "✓ Condon development rules file exists"
    echo "Rules file size: $(wc -l < .cursor/rules/condon-development.mdc) lines"
else
    echo "✗ Condon development rules file not found"
fi

...
# Comprehensive validation script for Condon installation within virtual environment

set -e

echo "=== Condon Virtual Environment Installation Validation ==="
...
# Test Condon CLI availability
echo "2. Testing Condon CLI availability..."
codon --version
codon --help
...
echo "PATH includes Condon: $PATH" | grep -q ".codon" && echo "✓ PATH configured" || echo "⚠ PATH may not be configured"
...
echo "✓ Condon CLI available (version: $(codon --version))"
